import cv2
import numpy as np
from src.config import PRE_PROCESSAMENTO, FILTRAGEM_CONTORNOS, DESENHO, ANGULACAO, ANGULACAO_PENTAGONO_REG, ANGULACAO_HEXAGONO_REG, FILTRO_KALMAN, SOLIDEZ
